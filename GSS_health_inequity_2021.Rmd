...
It's even worse after accounting for the weights, so we can not use the
chi squared test for the year 2021 separately.
...
For the 2021 dataset I would like to try bootstrap technique, because
number of observations is too small, but I also will leave it for the
next time.
